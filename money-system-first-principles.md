---
title: "理财白痴的系统重建：一个不需要判断力的财务方案"
---

# 理财白痴的系统重建：一个不需要判断力的财务方案
...
flowchart TB
    subgraph 结论["三个结论"]
        C1["结论一：买整个市场<br/>（概率推论）"]
        C2["结论二：规则替判断<br/>（行为法则）"]
        C3["结论三：短钱长钱分开<br/>（逻辑公理）"]
    end

    C3 --> S1["<b>三层架构</b><br/>防御→稳健→增值<br/>结论三的落地骨架"]
    
    S1 --> C1_DETAIL
    C1 --> C1_DETAIL["<b>六条件过滤</b><br/>第三层填什么？<br/>宽基指数 + 全球指数"]
    
    S1 --> C2_DETAIL
    C2 --> C2_DETAIL["<b>五条运行规则</b><br/>自动扣、不看、不动<br/>结论二的落地保护"]
