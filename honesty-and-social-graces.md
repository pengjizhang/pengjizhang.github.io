...
人有自私、有欲望、有面子、有偏见、有情绪、有恐惧、有虚荣、有不安，有自己的信念系统，有自己的利益目的。

如果人是机器，沟通就简单了：你说真话 → 对方逻辑处理 → 接受 → 问题解决。但人不是。真话在到达对方之前，要穿过四层人性的过滤——每一层都在削信号。
...
graph TD
    ...
    subgraph L1["第一层：情绪反应层"]
        B["⚡ 情绪判断：威胁 or 友好？"]
        B_detail["反应速度：毫秒级<br/>比逻辑快一千倍<br/>情绪先到，逻辑后到"]
    end

    subgraph L2["第二层：认知加工层"]
        C["🔍 偏见和信念过滤：<br/>跟我的地图对得上吗？"]
        C_detail["确认偏误、锚定、损失厌恶<br/>信息被扭曲、选择性接收<br/>不符 → 拒收 / 符合 → 通过"]
    end

    subgraph L3["第三层：自利动机层"]
        D["🎯 利益判断：<br/>这对我意味着什么？"]
        D_detail["自私、欲望、目的<br/>帮到我？→ 加速接收<br/>挡到我？→ 抵触排斥"]
    end

    subgraph L4["第四层：自我保护层"]
        E["🛡️ 价值判断：<br/>我这个人被否定了吗？"]
        E_detail["面子、恐惧、不安、虚荣<br/>最深的一层，处理最慢<br/>但最终决定：听还是不听"]
    end

    subgraph 结果
        F["👂 真正被听到的<br/>已经和原话完全不同"]
    end
...
四层叠在一起，解释了同一件事：**沟通不是信息传输，沟通是在人性里穿行。** 你说的话，在穿过这四层之前，对方根本没"听到"。
...
| 层 | 第一句（"你不行"） | 第三句（"一起验证"） |
|---|---|---|
| 情绪层 | 被批评 → 威胁 → 防御 | 先认可 → 友好 → 放松 |
| 认知层 | "他说我不懂" → 拒收 | "帮我找盲区" → 接收 |
| 自利层 | "挡我创业" → 对立 | "帮我提高成功率" → 一致 |
| 保护层 | "我被否定了" → 信道断 | "方案需要完善，人没事" → 安全 |

第一句话在每一层都被削，信号归零。第三句话穿过了四层，到位了。
...
**第一层，地基：** 人不是机器。四层人性——情绪、认知、自利、保护——真话要穿过它们才能到。沟通是在人性里穿行。
